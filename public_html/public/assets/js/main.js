    ...
    $(document).ready(function() {
        ...
        */
        ...
        $('.services-slider').each(function() {
            ...
            // Disable infinite mode if there aren't enough slides
            var shouldInfinite = slidesCount > slidesToShow;
        ...
        */
        ...
        /*-----------------
            Nice Select
        ------------------*/
        // Initialize nice-select only on select elements that are not inside SweetAlert or other modal containers
        function initNiceSelect() {
            $('select').not('.swal2-select').each(function() {
                // Skip if inside SweetAlert container
                if ($(this).closest('.swal2-container, .swal2-popup, .swal2-toast').length) {
                    return;
                }
