...
class PagesController extends Controller
{
    ...
    {
        $services = Service::where('is_featured', 1)->orderByRaw('sort_order = 0')->orderBy('sort_order')->orderBy('id')->take(8)->get();
        if ($services->isEmpty()) {
            $services = Service::orderByRaw('sort_order = 0')->orderBy('sort_order')->orderBy('id')->take(8)->get();
        }
    ...
    public function services(Request $request)
    {
        ...
        return view('front.services',[
            'services'                  =>$services->orderByRaw('sort_order = 0')->orderBy('sort_order')->orderBy('id')->paginate(9),
