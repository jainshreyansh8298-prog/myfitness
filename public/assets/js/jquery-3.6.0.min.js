...
!function(e, t) {
    ...
    b.extend = b.fn.extend = function() {
        ...
        a--); a < u; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    r = e[t],
                    "__proto__" !== t && s !== r && (l && r && (b.isPlainObject(r) || (i = Array.isArray(r))) ? (n = s[t],
                    o = i && !Array.isArray(n) ? [] : i || b.isPlainObject(n) ? n : {},
                    i = !1,
                    s[t] = b.extend(l, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }
    ,
    b.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (_(Object(e)) ? b.merge(n, "string" == typeof e ? [e] : e) : s.call(n, e)),
            n
        },
    ...
    var T = function(e) {
        var t, n, r, i, o, s, a, u, l, c, f, p, d, h, g, v, m, y, $, x = "sizzle" + 1 * new Date, b = e.document, _ = 0, T = 0, w = el(), C = el(), k = el(), S = el(), N = function(e, t) {
            return e === t && (f = !0),
            0
        }, E = {}.hasOwnProperty, A = [], D = A.pop, j = A.push, q = A.push, L = A.slice, H = function(e, t) {
            for (var n = 0, r = e.length; n < r; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, P = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", O = "[\\x20\\t\\r\\n\\f]", I = "(?:\\\\[\\da-fA-F]{1,6}" + O + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", M = "\\[" + O + "*(" + I + ")(?:" + O + "*([*^$|!~]?=)" + O + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + O + "*\\]", W = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + M + ")*)|.*)\\)|)", B = RegExp(O + "+", "g"), R = RegExp("^" + O + "+|((?:^|[^\\\\])(?:\\\\.)*)" + O + "+$", "g"), F = RegExp("^" + O + "*," + O + "*"), z = RegExp("^" + O + "*([>+~]|" + O + ")" + O + "*"), X = RegExp(O + "|>"), U = RegExp(W), V = RegExp("^" + I + "$"), G = {
            ID: RegExp("^#(" + I + ")"),
            CLASS: RegExp("^\\.(" + I + ")"),
            TAG: RegExp("^(" + I + "|[*])"),
            ATTR: RegExp("^" + M),
        ...
        }, Y = /HTML$/i, Q = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, et = RegExp("\\\\[\\da-fA-F]{1,6}" + O + "?|\\\\([^\\r\\n\\f])", "g"), en = function(e, t) {
            var n = "0x" + e.slice(1) - 65536;
            return t || (n < 0 ? String.fromCharCode(n + 65536) : String.fromCharCode(n >> 10 | 55296, 1023 & n | 56320))
        }, er = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ei = function(e, t) {
        ...
        function eu(e, t, r, i) {
            var o, a, l, c, f, h, m, y = t && t.ownerDocument, b = t ? t.nodeType : 9;
            if (r = r || [],
            ...
            g)) {
                ...
                if (n.qsa && !S[e + " "] && (!v || !v.test(e)) && (1 !== b || "object" !== t.nodeName.toLowerCase())) {
                    if (m = e,
                    y = t,
                    1 === b && (X.test(e) || z.test(e))) {
                        for ((y = ee.test(e) && ey(t.parentNode) || t) === t && n.scope || ((c = t.getAttribute("id")) ? c = c.replace(er, ei) : t.setAttribute("id", c = x)),
                        a = (h = s(e)).length; a--; )
        ...
        p = eu.setDocument = function(e) {
            ...
            m = [],
            v = [],
            (n.qsa = J.test(d.querySelectorAll)) && (ef(function(e) {
                var t;
            ...
            $ = (t = J.test(h.compareDocumentPosition)) || J.test(h.contains) ? function(e, t) {
        ...
        (r = eu.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        var l, c, f, p, d, h, g = o !== s ? "nextSibling" : "previousSibling", v = t.parentNode, m = a && t.nodeName.toLowerCase(), y = !u && !a, $ = !1;
                        if (v) {
                            if (o) {
                                for (; g; ) {
                                    for (p = t; p = p[g]; )
                            ...
                            s && y) {
                                for ($ = (d = (l = (c = (f = (p = v)[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === _ && l[1]) && l[2],
                                p = d && v.childNodes[d]; p = ++d && p && p[g] || ($ = d = 0) || h.pop(); )
                                    if (1 === p.nodeType && ++$ && p === t) {
                                        c[e] = [_, d, $];
                                        break
                                    }
                            } else if (y && ($ = d = (l = (c = (f = (p = t)[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === _ && l[1]),
                            !1 === $)
                                for (; (p = ++d && p && p[g] || ($ = d = 0) || h.pop()) && (!((a ? p.nodeName.toLowerCase() === m : 1 === p.nodeType) && ++$) || (y && ((c = (f = p[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [_, $]),
                                p !== t)); )
                                    ;
                            return ($ -= i) === r || $ % r == 0 && 0 <= $ / r
                        }
                ...
                PSEUDO: function(e, t) {
                    ...
                    return i[x] ? i(t) : 1 < i.length ? (n = [e, e, "", t],
                    r.setFilters.hasOwnProperty(e.toLowerCase()) ? ec(function(e, n) {
            ...
            pseudos: {
                ...
                lang: ec(function(e) {
                    return V.test(e || "") || eu.error("unsupported lang: " + e),
            ...
            ec(function(o, s, a, u) {
                var l, c, f, p = [], d = [], h = s.length, g = o || function(e, t, n) {
                    for (var r = 0, i = t.length; r < i; r++)
                        eu(e, t[r], n);
                    return n
                }(t || "*", a.nodeType ? [a] : a, []), v = e && (o || !t) ? eT(g, p, e, a, u) : g, m = n ? i || (o ? e : h || r) ? [] : s : v;
                if (n && n(v, m, a, u),
                r)
                    for (l = eT(m, d),
                    r(l, [], a, u),
                ...
                if (o) {
                    ...
                    m = eT(m === s ? m.splice(h, m.length) : m),
        ...
        return e$.prototype = r.filters = r.pseudos,
        r.setFilters = new e$,
        ...
        a = eu.compile = function(e, t) {
            ...
            if (!v) {
                ...
                c = function(e, t, n, s, c) {
                    var f, h, v, m = 0, y = "0", $ = e && [], x = [], b = l, T = e || u && r.find.TAG("*", c), w = _ += null == b ? 1 : Math.random() || .1, C = T.length;
                    ...
                    a && y !== m) {
                        ...
                        q.apply(s, x),
                        c && !e && 0 < x.length && 1 < m + o.length && eu.uniqueSort(s)
                    }
                    return c && (_ = w,
                    l = b),
                    $
        ...
        u = eu.select = function(e, t, n, i) {
            ...
            return (p || a(e, d))(i, t, !g, n, !t || ee.test(e) && ey(t.parentNode) || t),
            n
        }
        ,
    ...
    b.fn.extend({
        ...
        closest: function(e, t) {
            var n, r = 0, i = this.length, o = [], s = "string" != typeof e && b(e);
            if (!k.test(e)) {
                for (; r < i; r++)
    ...
    b.each({
        ...
        b.fn[e] = function(n, r) {
            ...
            1 < this.length && (q[e] || b.uniqueSort(i),
            j.test(e) && i.reverse()),
            this.pushStack(i)
        }
    });
                            ...
                            var a = this
                              ...
                              , l = function() {
                                ...
                                if (!(t < o)) {
                                    ...
                                    h(l = e && ("object" == typeof e || "function" == typeof e) && e.then) ? i ? l.call(e, s(o, n, P, i), s(o, n, O, i)) : (o++,
                                    l.call(e, s(o, n, P, i), s(o, n, O, i), s(o, n, P, n.notifyWith))) : (r !== P && (a = void 0,
                                    u = [e]),
                                    (i || n.resolveWith)(a, u))
                                }
                            }
    ...
    b.ready.then = W.then,
    "complete" !== v.readyState && ("loading" === v.readyState || v.documentElement.doScroll) ? (v.addEventListener("DOMContentLoaded", B),
    e.addEventListener("load", B)) : e.setTimeout(b.ready);
    ...
    G.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t)
                    for (n = (t = Array.isArray(t) ? t.map(U) : ((t = U(t))in r) ? [t] : t.match(H) || []).length; n--; )
                        delete r[t[n]];
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                ...
                1 === o.nodeType && !Y.get(o, "hasDataAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && 0 === (r = s[n].name).indexOf("data-") && Z(o, r = U(r.slice(5)), i[r]);
    ...
    b.fn.extend({
        ...
        promise: function(e, t) {
            var n, r = 1, i = b.Deferred(), o = this, s = this.length, a = function() {
                --r || i.resolveWith(o, [o])
            };
    ...
    function ea(e, t, n, r) {
        ...
        , u = a(), l = n && n[3] || (b.cssNumber[t] ? "" : "px"), c = e.nodeType && (b.cssNumber[t] || "px" !== l && +u) && et.exec(b.css(e, t));
        if (c && c[3] !== l) {
            for (u /= 2,
            l = l || c[3],
            c = +u || 1; s--; )
    ...
    function el(e, t) {
        for (var n, r, i, o, s, a, u, l = [], c = 0, f = e.length; c < f; c++)
            ...
            l[c] || (r.style.display = "")),
            "" === r.style.display && es(r) && (l[c] = (u = s = o = void 0,
            s = (i = r).ownerDocument,
            (u = eu[a = i.nodeName]) || (o = s.body.appendChild(s.createElement(a)),
            u = b.css(o, "display"),
            o.parentNode.removeChild(o),
            "none" === u && (u = "block"),
            eu[a] = u)))) : "none" !== n && (l[c] = "none",
            Y.set(r, "display", n)));
        for (c = 0; c < f; c++)
    ...
    var ec, ef, ep = /^(?:checkbox|radio)$/i, ed = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, eh = /^$|^module$|\/(?:java|ecma)script/i;
    ...
    eg.th = eg.td,
    d.option || (eg.optgroup = eg.option = [1, "<select multiple='multiple'>", "</select>"]);
    var ey = /<|&#?\w+;/;
        ...
        for (var o, s, a, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++)
            if ((o = e[d]) || 0 === o) {
                if ("object" === $(o))
                    ...
                    u = eg[a = (ed.exec(o) || ["", ""])[1].toLowerCase()] || eg._default,
    ...
    b.event = {
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(H) || [""]).length; l--; )
                    ...
                    d) {
                        ...
                        s && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, v.handle) || b.removeEvent(e, d, v.handle),
                        delete u[d])
                    } else
                        for (d in u)
        ...
        dispatch: function(e) {
            var t, n, r, i, o, s, a = Array(arguments.length), u = b.event.fix(e), l = (Y.get(this, "events") || Object.create(null))[u.type] || [], c = b.event.special[u.type] || {};
            for (a[0] = u,
            t = 1; t < arguments.length; t++)
                a[t] = arguments[t];
            if (u.delegateTarget = this,
            !c.preDispatch || !1 !== c.preDispatch.call(this, u)) {
                for (s = b.event.handlers.call(this, u, l),
                t = 0; (i = s[t++]) && !u.isPropagationStopped(); )
                    ...
                    n = 0; (o = i.handlers[n++]) && !u.isImmediatePropagationStopped(); )
                        ...
                        u.data = o.data,
                        void 0 !== (r = ((b.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a)) && !1 === (u.result = r) && (u.preventDefault(),
                        u.stopPropagation()));
            ...
            if (u && l.nodeType && !("click" === e.type && 1 <= e.button)) {
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                        ...
                        s = {},
                        n = 0; n < u; n++)
                            void 0 === s[i = (r = t[n]).selector + " "] && (s[i] = r.needsContext ? -1 < b(i, this).index(l) : b.find(i, this, null, [l]).length),
                            s[i] && o.push(r);
                        o.length && a.push({
                            elem: l,
                            handlers: o
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return ep.test(t.type) && t.click && S(t, "input") && eC(t, "click", eb),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return ep.test(t.type) && t.click && S(t, "input") && eC(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    b.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? eb : e_,
    ...
    function eq(e, t, n, r) {
        ...
        if (p && (s = (i = e$(t, e[0].ownerDocument, !1, e, r)).firstChild,
        1 === i.childNodes.length && (i = s),
        s || r)) {
            for (u = (a = b.map(ev(i, "script"), eA)).length; f < p; f++)
                l = i,
                f !== g && (l = b.clone(l, !0, !0),
                u && b.merge(a, ev(l, "script"))),
                n.call(e[f], l, f);
            if (u)
                ...
                f = 0; f < u; f++)
                    l = a[f],
                    eh.test(l.type || "") && !Y.access(l, "globalEval") && b.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? b._evalUrl && !l.noModule && b._evalUrl(l.src, {
    ...
    function eL(e, t, n) {
        for (var r, i = t ? b.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            ...
            r.parentNode && (n && ei(r) && em(ev(r, "script")),
    ...
    b.extend({
        ...
        clone: function(e, t, n) {
            var r, i, o, s, a, u, l, c = e.cloneNode(!0), f = ei(e);
            if (!(d.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || b.isXMLDoc(e)))
                for (s = ev(c),
                r = 0,
                i = (o = ev(e)).length; r < i; r++)
                    a = o[r],
                    "input" === (l = (u = s[r]).nodeName.toLowerCase()) && ep.test(a.type) ? u.checked = a.checked : "input" !== l && "textarea" !== l || (u.defaultValue = a.defaultValue);
            if (t) {
                if (n)
                    for (o = o || ev(e),
                    s = s || ev(c),
            ...
            return 0 < (s = ev(c, "script")).length && em(s, !f && ev(e, "script")),
            c
        },
    ...
    b.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (b.cleanData(ev(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return R(this, function(e) {
                ...
                if ("string" == typeof e && !ek.test(e) && !eg[(ed.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++)
                            1 === (t = this[n] || {}).nodeType && (b.cleanData(ev(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (i) {}
                }
        ...
        replaceWith: function() {
            ...
            return eq(this, arguments, function(t) {
                ...
                0 > b.inArray(this, e) && (b.cleanData(ev(this)),
    ...
    function eI(e, t, n) {
        ...
        return (n = n || eP(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || ei(e) || (s = b.style(e, t)),
        !d.pixelBoxStyles() && eH.test(s) && e0.test(t) && (r = a.width,
        i = a.minWidth,
        o = a.maxWidth,
    ...
    function e2(e, t, n, r, i, o) {
        ...
        for (; s < 4; s += 2)
            ...
            r ? ("content" === n && (u -= b.css(e, "padding" + en[s], !0, i)),
            "margin" !== n && (u -= b.css(e, "border" + en[s] + "Width", !0, i))) : (u += b.css(e, "padding" + en[s], !0, i),
            "padding" !== n ? u += b.css(e, "border" + en[s] + "Width", !0, i) : a += b.css(e, "border" + en[s] + "Width", !0, i));
    ...
    function eU(e, t, n) {
        ...
        return (!d.boxSizingReliable() && i || !d.reliableTrDimensions() && S(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === b.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === b.css(e, "boxSizing", !1, r),
        (o = a in e) && (s = e[a])),
        (s = parseFloat(s) || 0) + e2(e, t, n || (i ? "border" : "content"), o, r, s) + "px"
    }
    ...
    b.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = U(t), u = eF.test(t), l = e.style;
                if (u || (t = e9(a)),
                s = b.cssHooks[t] || b.cssHooks[a],
                void 0 === n)
                    return s && "get"in s && void 0 !== (i = s.get(e, !1, r)) ? i : l[t];
                "string" == (o = typeof n) && (i = et.exec(n)) && i[1] && (n = ea(e, t, i),
                o = "number"),
                null != n && n == n && ("number" !== o || u || (n += i && i[3] || (b.cssNumber[a] ? "" : "px")),
    ...
    b.each(["height", "width"], function(e, t) {
        b.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !eR.test(b.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? eU(e, t, r) : eO(e, e8, function() {
                        return eU(e, t, r)
                    })
            },
            set: function(e, n, r) {
                var i, o = eP(e), s = !d.scrollboxSize() && "absolute" === o.position, a = (s || r) && "border-box" === b.css(e, "boxSizing", !1, o), u = r ? e2(e, t, r, a, o) : 0;
                return a && s && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - e2(e, t, "border", !1, o) - .5)),
                u && (i = et.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                n = b.css(e, t)),
                eX(0, n, u)
            }
        }
    ...
    b.cssHooks.marginLeft = eM(d.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(eI(e, "marginLeft")) || e.getBoundingClientRect().left - eO(e, {
                marginLeft: 0
            }, function() {
    ...
    b.fx.step = {};
    var e4, e7, eV, eG, eY = /^(?:toggle|show|hide)$/, eQ = /queueHooks$/;
    function e6() {
    ...
    function eJ(e, t, n) {
        var r, i, o = 0, s = eJ.prefilters.length, a = b.Deferred().always(function() {
            delete u.elem
        }), u = function() {
            if (i)
                return !1;
            for (var t = e4 || e6(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, s = l.tweens.length; o < s; o++)
                l.tweens[o].run(r);
    ...
    b.Animation = b.extend(eJ, {
        tweeners: {
            "*": [function(e, t) {
                ...
                return ea(n.elem, e, et.exec(t), n),
                n
            }
            ]
        },
        ...
        prefilters: [function(e, t, n) {
            var r, i, o, s, a, u, l, c, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && es(e), v = Y.get(e, "fxshow");
            for (r in n.queue || (null == (s = b._queueHooks(e, "fx")).unqueued && (s.unqueued = 0,
            a = s.empty.fire,
            ...
            if ((u = !b.isEmptyObject(t)) || !b.isEmptyObject(d))
                ...
                "none" === (c = b.css(e, "display")) && (l ? c = l : (el([e], !0),
                l = e.style.display || l,
                c = b.css(e, "display"),
                el([e]))),
    ...
    b.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = Y.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = b.timers, s = r ? r.length : 0;
                for (n.finish = !0,
                b.queue(this, e, []),
    ...
    b.fx.start = function() {
        e7 || (e7 = !0,
        function t() {
            e7 && (!1 === v.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(t) : e.setTimeout(t, b.fx.interval),
            b.fx.tick())
        }())
    }
    ,
    ...
    b.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? b.prop(e, t, n) : (1 === o && b.isXMLDoc(e) || (i = b.attrHooks[t.toLowerCase()] || (b.expr.match.bool.test(t) ? eZ : void 0)),
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each(function(n) {
                ...
                if (r)
                    ...
                    void 0 !== e && "boolean" !== n || ((t = ti(this)) && Y.set(this, "__className__", t),
    ...
    b.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, r, i = e.options, o = b.makeArray(t), s = i.length; s--; )
                        ((r = i[s]).selected = -1 < b.inArray(b.valHooks.option.get(r), o)) && (n = !0);
    ...
    b.extend(b.event, {
        trigger: function(t, n, r, i) {
            var o, s, a, u, l, f, p, d, m = [r || v], y = c.call(t, "type") ? t.type : t, $ = c.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = d = a = r = r || v,
            3 !== r.nodeType && 8 !== r.nodeType && !ta.test(y + b.event.triggered) && (-1 < y.indexOf(".") && (y = ($ = y.split(".")).shift(),
            $.sort()),
            l = 0 > y.indexOf(":") && "on" + y,
            ...
            i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!i && !p.noBubble && !g(r)) {
                    ...
                    ta.test(u + y) || (s = s.parentNode); s; s = s.parentNode)
                        m.push(s),
                        a = s;
    ...
    b.parseXML = function(t) {
        ...
        n && !r || b.error("Invalid XML: " + (r ? b.map(r.childNodes, function(e) {
            return e.textContent
        }).join("\n") : t)),
        n
    }
    ...
    b.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var r, i, o, s, a, u, l, c, f, p, d = b.ajaxSetup({}, n), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? b(h) : b.event, m = b.Deferred(), y = b.Callbacks("once memory"), $ = d.statusCode || {}, x = {}, _ = {}, T = "canceled", w = {
                readyState: 0,
                ...
                setRequestHeader: function(e, t) {
                    return null == l && (x[e = _[e.toLowerCase()] = _[e.toLowerCase()] || e] = t),
                    this
                },
            ...
            if (m.promise(w),
            d.url = ((t || d.url || tl.href) + "").replace(t_, tl.protocol + "//"),
            ...
            null == d.crossDomain) {
                ...
                try {
                    u.href = d.url,
                    u.href = u.href,
                    d.crossDomain = tk.protocol + "//" + tk.host != u.protocol + "//" + u.host
                } catch (C) {
                    d.crossDomain = !0
                }
            }
            ...
            i = d.url.replace(ty, ""),
            d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(tm, "+")) : (p = d.url.slice(i.length),
            d.data && (d.processData || "string" == typeof d.data) && (i += (tf.test(i) ? "&" : "?") + d.data,
            delete d.data),
            !1 === d.cache && (i = i.replace(t$, "$1"),
            p = (tf.test(i) ? "&" : "?") + "_=" + tc.guid++ + p),
            d.url = i + p),
            d.ifModified && (b.lastModified[i] && w.setRequestHeader("If-Modified-Since", b.lastModified[i]),
            ...
            w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + tC + "; q=0.01" : "") : d.accepts["*"]),
            d.headers)
            ...
            function S(t, n, s, u) {
                ...
                !f && -1 < b.inArray("script", d.dataTypes) && 0 > b.inArray("json", d.dataTypes) && (d.converters["text script"] = function() {}
                ),
                x = function(e, t, n, r) {
                ...
                f ? (d.ifModified && ((_ = w.getResponseHeader("Last-Modified")) && (b.lastModified[i] = _),
                ...
                send: function(i, o) {
                    ...
                    n = function(e) {
                        return function() {
                            ...
                            "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(tA[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                binary: a.response
                            } : {
                                text: a.responseText
    ...
    b.ajaxPrefilter("json jsonp", function(t, n, r) {
        ...
        if (a || "jsonp" === t.dataTypes[0])
            ...
            a ? t[a] = t[a].replace(tL, "$1" + i) : !1 !== t.jsonp && (t.url += (tf.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
            t.converters["script json"] = function() {
                return s || b.error(i + " was not called"),
                s[0]
            }
            ,
            t.dataTypes[0] = "json",
    ...
    d.createHTMLDocument = ((tj = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    b.parseHTML = function(e, t, n) {
        ...
        o = !n && [],
        (i = N.exec(e)) ? [t.createElement(i[1])] : (i = e$([e], t, o),
    ...
    b.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, s, a, u, l = b.css(e, "position"), c = b(e), f = {};
        ...
        b.each({
            ...
            b.fn[r] = function(i, o) {
                ...
                return R(this, function(t, n, i) {
                    ...
                    Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === i ? b.css(t, n, a) : b.style(t, n, i, a)
                }, t, s ? i : void 0, s)
            }
        })
    }),
